...
static bool
protoneg_check_protocol(uint8_t **pout, uint8_t *pout_len, const uint8_t *in,
...
static bool
dot_select_next_protocol(uint8_t **pout, uint8_t *pout_len, const uint8_t *in,
			 size_t in_len) {
...
dot_alpn_select_proto_cb(SSL *ssl, const unsigned char **out,
	...
	ret = dot_select_next_protocol((uint8_t **)(uintptr_t)out, outlen, in,
				       inlen);
